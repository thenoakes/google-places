...
function updateSortDescription(criterion) {
    ...
    switch (criterion) {
        case 'gpName': 
            description = 'sorted alphabetically'; break;
        case 'gpRating': 
            description =  'showing best rated first'; break;
        case 'gpDistance': 
            description =  'showing closest first'; break;
        case 'gpOpen': 
            description =  'showing currently open first'; break;
    }
    document.getElementById('sort-description').innerText = description;
}

document.getElementById('result-sorter').addEventListener('click', function (evt) {
